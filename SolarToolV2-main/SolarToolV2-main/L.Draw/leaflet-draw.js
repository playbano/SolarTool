...
!(function (t, e, i) {
  ...
  (L.drawVersion = "1.0.4"),
    ...
    (L.drawLocal = {
      draw: {
        toolbar: {
          actions: { title: "Avbryt ritning", text: "Avbryt" },
          finish: { title: "Färdigställ ritning", text: "Färdigställ" },
          undo: { title: "Ta bort senaste punkten", text: "Ta bort" },
          buttons: {
            polyline: "Draw a polyline",
            polygon: "Ritverktyg", // Vad det står vid hover
        ...
        handlers: {
          ...
          marker: { tooltip: { start: "Klicka för att placera markör" } },
          polygon: {
            tooltip: {
              start: "Klicka för att börja rita",
              cont: "Klicka för att sätta nästa punkt",
              end: "Klicka på första punkt för att färdigställa",
            },
          },
          polyline: {
      ...
      edit: {
        toolbar: {
          actions: {
            save: { title: "Spara ändringar", text: "Spara" },
            cancel: {
              title: "Avbryt och ta bort ändringar",
              text: "Avbryt",
            },
            clearAll: { title: "Radera alla former", text: "Radera allt" },
          },
          buttons: {
            edit: "Justera form",
            editDisabled: "Inga former att redigera",
            remove: "Ta bort form",
            removeDisabled: "Inga former att radera",
          },
        },
        handlers: {
          edit: {
            tooltip: {
              text: "Dra punkter för att ändra",
              subtext: "'Avbryt' för att ta bort ändringar",
            },
          },
          remove: { tooltip: { text: "Klicka för att ta bort" } },
        },
      },
    }),
    (L.Draw.Event = {}),
